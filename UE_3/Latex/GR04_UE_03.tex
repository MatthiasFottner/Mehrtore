...
\begin{center}
  \includegraphics[width=1\linewidth]{./Assets/SP_a}
...
\begin{center}
  \includegraphics[width=1\linewidth]{./Assets/SP_b}
...
\begin{center}
  ...
  \includegraphics[scale=1.2]{./Assets/gesamter Schaltvorgang.pdf}
...
\begin{center}
  % \includegraphics[width=1\linewidth]{./Assets/gesamter Schaltvorgang - PSpice}
  \includegraphics[scale=1.2]{./Assets/u_C_plot.pdf}
